import { heroBanners, visionMission, treatments, contactInfo } from "../constants";
...
const Home = () => {
    return (
        <main className="flex-1">
            ...
            <section className="w-full py-16 md:py-24 bg-white dark:bg-[#2a161c]">
                <div className="max-w-[1440px] mx-auto px-4 md:px-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
                        ...
                        <div className="w-full h-[400px] lg:h-auto rounded-2xl overflow-hidden shadow-lg border border-[#e6d1d7] dark:border-primary/20 relative bg-gray-100 dark:bg-gray-800">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                <div className="bg-white/90 backdrop-blur px-6 py-3 rounded-full shadow-lg border border-primary/20 flex items-center gap-2">
